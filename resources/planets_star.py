...
from models.datamodels.planets import Planet_, PatchPlanet
...
def get_planets():
    ...
    planets_ = parse_obj_as(List[Planet_], planets)
    planets_data = []
    for planet in planets_:
        planet = Planet_(**dict(planet))
        data = planet.json()
